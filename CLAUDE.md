...
- **2026-03-26**: Documentation maintenance — updated `README.md`, `docs/ARCHITECTURE.md`, `docs/ROADMAP.md`, `docs/adr/README.md` to reflect ADR-020/021 entity renames and recent feature work. Project structure, Features, Key Bindings, Tech Stack, Domain Model taxonomy, DDD Phase 7, Phase C English translation, Completed entries, ADR-009 supersession all updated.
