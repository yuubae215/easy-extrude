...
Phase 3 に混ぜると 2 つの判断が 1 つの PR で不可分になる。**未着手のまま残る** —
段を持たない項目は誰も実装しないので、ここに宣言として置く。次にこれを拾う段は
Phase 3.5 の延長として起票すること (`docs/ia-redesign/easy-extrude-wireframe-v8.html`
注釈② が仕様の正本)。
