...
| [ADR-106](ADR-106-the-floor-is-a-table-not-a-strip.md) | **場は表であって縦帯ではない — 器を中身の形へ合わせ、右端の排他を「住所」で解く** | Proposed (IA 再設計 Phase 3) | 2026-08-02 | ADR-050, ADR-047, ADR-105, ADR-104, ADR-103, ADR-102, ADR-063, ADR-094 |
