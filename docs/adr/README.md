...
| [ADR-069](ADR-069-ux-parity-pass.md) | **UX パリティ・パス Phase 1 — ギズモを CameraFlight へ / Link Network は動きでなく状態で凡例化 / 位相リンク切断 / Frame 命名統一** | Accepted (Phase 1; Phase 2→ADR-070・Phase 3→ADR-071 実装済; Phase 4 未着手) | 2026-07-14 | ADR-068, ADR-048, ADR-030, ADR-038, ADR-037 |
