...
| [ADR-053](ADR-053-robotics-kpi-methods.md) | **ロボティクス KPI メソッド — 測定器としての運動学/軌道/干渉計算と可視検証ループ** | Proposed | 2026-06-20 | ADR-038, ADR-047, ADR-049, ADR-052, ADR-027, ADR-015, ADR-017 |
