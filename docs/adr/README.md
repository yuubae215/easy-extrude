...
| [ADR-052](ADR-052-5w1h-ubiquitous-language.md) | **5W1H ユビキタス言語 — NL ⇄ データの Mutual 構造（Why ルートの正準ツリー）** | Accepted (Phase 1 + Phase 2 + Phase 3 実装済) | 2026-06-17 | ADR-046, ADR-044, ADR-049, ADR-048, ADR-050, ADR-051 |
