...
| [ADR-051](ADR-051-requirement-intake.md) | **要件入力（Requirement Intake）— あいまい要件を起点化する複数入口アーキテクチャ** | Proposed | 2026-06-16 | ADR-050, ADR-049, ADR-047, ADR-046, ADR-044, ADR-022, ADR-013 |
