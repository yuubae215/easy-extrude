...
| [ADR-065](ADR-065-front-playfulness-program.md) | **体感層の全面遊戯化プログラム — front は遊び場、back は証明のまま** | Accepted (Phase 0+1+2 実装済; Phase 3–6 後続) | 2026-07-09 | ADR-062, ADR-064, ADR-061, ADR-059, ADR-058, ADR-047 |
