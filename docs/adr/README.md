...
| [ADR-015](ADR-015-bff-microservices-architecture.md) | **BFF + Microservices Architecture** | Proposed | 2026-03-20 | ADR-011, ADR-012, ADR-013 |
| [ADR-016](ADR-016-transform-graph-scene-relationships.md) | **Transform Graph — Spatial Relationships Between Scene Objects** | Proposed | 2026-03-21 | ADR-012, ADR-015 |
