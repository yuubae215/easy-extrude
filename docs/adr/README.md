...
| [ADR-104](ADR-104-ownership-proposal-and-the-receipt.md) | **編集の住所は所有権で決まり、記録は人の行為から始まる — 所有権・提案・証憑モデル** | Accepted (設計確定 — 未解決 4 点を決着し STATE_TRANSITIONS §提案/§議題 を起こした。実装は IA 再設計 Phase 4) | 2026-08-02 | ADR-050, ADR-049, ADR-052, ADR-056, ADR-077, ADR-090, ADR-100, ADR-065, ADR-103 |
