...
| [ADR-058](ADR-058-context-authoring-fork-and-tweak.md) | **Context オーサリング UX — 例を土台に編集する（fork & tweak）** | Accepted (Phase 1 + actor/variable seed chips 実装済) | 2026-06-30 | ADR-051, ADR-050, ADR-046, ADR-049, ADR-052, ADR-057 |
