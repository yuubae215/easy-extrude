...
| [ADR-099](ADR-099-selection-round-trip-one-entry.md) | **選択の往復を 1 つの入口へ — hover が click を殺す再構築の閉路を断ち、選択を「見えること」まで含む 1 つの決定にする** | Accepted | 2026-07-26 | ADR-094, ADR-095, ADR-096, ADR-097, ADR-090, ADR-093 |
