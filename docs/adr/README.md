...
| [ADR-049](ADR-049-requirement-conflict-model.md) | **Requirement / Conflict モデル — KPI 由来の許容領域・衝突検出・交渉クラスター** | Draft (Phase 1+2 実装済) | 2026-06-13 | ADR-046, ADR-047, ADR-044, ADR-035 |
