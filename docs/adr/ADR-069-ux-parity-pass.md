...
- Status: Accepted (Phase 1 実装済; Phase 2 = ADR-070・Phase 3 = ADR-071・Phase 4 = ADR-072 として 2026-07-15 すべて Accepted・実装済 — **本パリティ・パス完結**)
- Date: 2026-07-14
...
- ADR-073(生成時に命名フォームを出さない — 本 ADR の `nextEntityName` 統一の上に
  「ダイアログ自体を廃止」を積む後続)
