...
**着手順の推奨 (2026-08-14 再改訂):** G-0 / G-2 / G-3 は完了。`ikSolvable` が代理では
なくなったので、その上に積む前提は揃った。次は **G-1 (ADR-121 重心)** → **G-4
(ADR-122 pickable と歩留まり)**。G-4 の D2 (`pick-sequence` の入口) は
`contractVersion` を上げる回になるので、**DEF-029 (死んだ 3 本目の端) がそこへ相乗り
する**。
